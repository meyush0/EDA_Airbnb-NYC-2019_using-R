...
```{r}
 ...
 # conduct ANOVA
 model <- lm(price ~ room_type, data = my_data)
 summary(model)
 
 #The p-values for both predictor variables are less than 0.001, indicating that both variables are statistically significant predictors of price. 
 #The adjusted R-squared value of 0.08269 suggests that the model explains only a small proportion of the variation in price.
